...
def generate_syllogisms(schema, pool, validity, plausibility, count = 1):
    ...
    for _ in range(count):
        ...
        while True:
            ...
            relevant_premises = [prem1.format(A = A_four, B = B_four_first, C = C_four), prem2.format(A = A, B = B_four_second, C = C_four)]
...
for i in languages:
        ...
        with open(f"st4_{i}_simple_symbolic_4_var_one.json", "w", encoding="utf-8") as f:
