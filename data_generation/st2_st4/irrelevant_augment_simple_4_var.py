...
def generate_syllogisms(schema, chain_type, validity, plausibility, count=1, used_nouns_tracker=None):
    ...
    for _ in range(count):
        while True:
            ...
            # Extract the first variables from each premise
            ...
            # Apply 4-variable conversion based on first variable in each premise
            ...
            relevant_premises = [prem1.format(A=A_four, B=B_four_first, C=C), prem2.format(A=A, B=B_four_second, C=C_four)]
            
            # --- Generate irrelevant premises with 4-variable format ---
            type_0_pool = []
...
for i in languages:
        ...
        # --- Valid Plausible ---
        all_data += generate_syllogisms(valid_plausible_same_chain, "valid_p_same_chain", True, True, 699, used_nouns)
        all_data += generate_syllogisms(valid_plausible_diff_chain_C, "valid_p_diff_chain_C", True, True, 1010, used_nouns)
        ...
        with open(f"st4_{i}_simple_4_var.json", "w", encoding="utf-8") as f:
